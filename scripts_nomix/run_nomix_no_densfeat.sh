...
YAML_FILE="scripts_nomix/nomix-fluid-no_densfeat.yaml"
...
NUMSTEPS=400
GPU_ID="0"  # 默认使用GPU 0
WEIGHTS="/workspace/xyh_synology/graduate/weights/nomix-fluid/ablation-no_densfeat/train_network_nomix_tf_nomix-fluid-no_densfeat_2025_04_23/checkpoints/ckpt-22000.index"
