...
LOG_FILE="scripts_nomix/run_nomix_single_dens_no_sym_${DATE}.log"  # 定义日志文件名，包含日期和时间
...
NUMSTEPS=400
GPU_ID="0"  # 默认使用GPU 0
WEIGHTS="/workspace/xyh_synology/graduate/weights/nomix-fluid/ablation-single_dens-no_sym/train_network_nomix_tf_nomix-single-dens-no_sym_2025_05_06/checkpoints/ckpt-2000.index"
