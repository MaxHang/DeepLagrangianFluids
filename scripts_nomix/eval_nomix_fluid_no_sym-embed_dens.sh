...
# 定义变量, 批量处理文件夹
EVAL_SCRIPT="scripts/evaluate_nomix_network.py"
TRAIN_SCRIPT="scripts/train_network_nomix_tf.py"
YAML_FILE="scripts_nomix/nomix-no_sym-embed_dens.yaml"
DATE=$(date +"%Y%m%d_%H%M%S")  # 获取当前日期和时间，格式为 YYYYMMDD_HHMMSS
LOG_FILE="scripts_nomix/log_eval/eval_nomix_no_sym_embed_dens_${DATE}.log"  # 定义日志文件名，包含日期和时间
...
WEIGHTS="/workspace/xyh_synology/graduate/weights/nomix-fluid/ablation_no_sym_embed_dens/train_network_nomix_tf_nomix-no_sym-embed_dens_2025_05_07/checkpoints/ckpt-23000.index"
