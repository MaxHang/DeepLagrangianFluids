...
YAML_FILE="scripts_nomix/nomix-single-dens-no_multi-no_sym.yaml"
DATE=$(date +"%Y%m%d_%H%M%S")  # 获取当前日期和时间，格式为 YYYYMMDD_HHMMSS
LOG_FILE="scripts_nomix/run_nomix_single_dens_no_multi_no_sym_${DATE}.log"  # 定义日志文件名，包含日期和时间
...
NUMSTEPS=400
GPU_ID="0"  # 默认使用GPU 0
WEIGHTS="/workspace/xyh_synology/graduate/weights/nomix-fluid/ablation-single_dens-no_multi-no_sym/train_network_nomix_tf_nomix-single-dens-no_multi_2025_05_05/checkpoints/ckpt-47000.index"
