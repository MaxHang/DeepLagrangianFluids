...
YAML_FILE="scripts_nomix/nomix-fluid-no_fluid_ones.yaml"
...
NUMSTEPS=400
GPU_ID="0"  # 默认使用GPU 0
WEIGHTS="/workspace/xyh_synology/graduate/weights/nomix-fluid/train_network_nomix_tf_nomix-fluid_2025_04_24/model_weights_2025_04_25.h5"
