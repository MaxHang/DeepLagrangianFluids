...
TRAIN_SCRIPT_PATH="${SCRIPT_DIR}/train_network_mix_tf_spearate_pos_phase.py"
...
# --- 4. 实验配置 (一一对应) ---
MODELS_TO_TEST=(
    /workspace/xyh_synology/graduate/weights/mix_separate_pos_phase/train_network_mix_tf_spearate_pos_phase_mix_separate_pos_phase_20250616/model_weights_2025_06_17.h5
)

CONFIGS_TO_USE=(
    /workspace/xyh_synology/graduate/weights/mix_separate_pos_phase/train_network_mix_tf_spearate_pos_phase_mix_separate_pos_phase_20250616/mix_separate_pos_phase.yaml
)
