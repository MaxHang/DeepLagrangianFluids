...
LOG_FILE="scripts_mix/log_run/mix_spearate_pos_phase_${DATE}.log"  # 定义日志文件名，包含日期和时间
SCENE="scripts_mix/run_mixfluid_valid_dataset_20260311.json"
OUTPUT="/workspace/xyh_synology/graduate/run_network/mix_fluid/ply_model_20250617_${DATE}"
NUMSTEPS=2000
# NUMSTEPS=800
GPU_ID="0"  # 默认使用GPU 0
