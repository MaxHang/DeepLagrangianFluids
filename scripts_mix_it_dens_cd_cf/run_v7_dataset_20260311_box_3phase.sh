...
LOG_FILE="scripts_mix_it_dens_cd_cf/log_run/run_v7_dataset_20260311_box_3phase_scene_${DATE}.log"  # 定义日志文件名，包含日期和时间
OUTPUT="/workspace/xyh_synology/graduate/run_network/mix_fluid/ply_dataset_20260311_box_3phase_scene_${DATE}"
SCENE="scripts_mix_it_dens_cd_cf/box_scene_3phase_datasets_20260311.json"
