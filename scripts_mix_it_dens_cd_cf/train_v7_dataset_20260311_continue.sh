...
YAML_FILE="/workspace/xyh_synology/graduate/weights/mix_it_dens_cd_cf_separate_pos_phase_v7/20260425170019/training_config.yaml"
DATE=$(date +"%Y%m%d_%H%M%S")  # 获取当前日期和时间，格式为 YYYYMMDD_HHMMSS
LOG_FILE="scripts_mix_it_dens_cd_cf/log_train/train_v7_dataset_20260311_${DATE}.log"  # 定义日志文件名，包含日期和时间
