...
YAML_FILE="scripts_mix_it_dens_cd_cf/mix_v12_dataset_20260112.yaml"
DATE=$(date +"%Y%m%d_%H%M%S")  # 获取当前日期和时间，格式为 YYYYMMDD_HHMMSS
LOG_FILE="scripts_mix_it_dens_cd_cf/log_train/train_v12_dataset_20260112_${DATE}.log"  # 定义日志文件名，包含日期和时间
