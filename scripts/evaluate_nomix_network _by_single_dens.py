    ...
    for data in val_dataset:
        ...
        if data['frame_id0'][0] % skip == 4:
            ...
            if len(
                ...
                inputs = (pr_pos1, pr_vel1, np.ones_like(density) * 1000, None, box, box_normals)
...
def main():
    ...
    val_files = sorted(glob(r'/workspace/xyh_synology/graduate/datasets/nomix-fluid-cconv/valid/*.h5'))
